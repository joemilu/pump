...
$HandlerLabel
	...
	IMPORT  |Image$$ER_ROM1$$RW$$Base|   ; Base of RAM to initialise
	IMPORT  |Image$$ER_ROM1$$ZI$$Base|   ; Base and limit of area
	IMPORT  |Image$$ER_ROM1$$ZI$$Limit|  ; to zero initialise
...
BaseOfBSS	DCD	|Image$$ER_ROM1$$RW$$Base|
BaseOfZero	DCD	|Image$$ER_ROM1$$ZI$$Base|
EndOfBSS	DCD	|Image$$ER_ROM1$$ZI$$Limit|
